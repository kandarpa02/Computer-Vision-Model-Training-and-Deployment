...
from ..train.base import Cell
from ..train.metric import Mean, Accuracy
    ...
    def fit(train_loader, val_loader):
        ...
        for e in range(START_EPOCHS, EPOCHS):
            ...
            for x, y in train_loader:
                ...
                train_loss, train_pred = batched_train_step(
                    x,
                    y,
                    auto_cast=auto_cast,
                )
            ...
            for x, y in val_loader:
                ...
                val_loss, val_pred = batched_val_step(
                    x,
                    y,
                    auto_cast=auto_cast,
                )
            ...
            if (e + 1) % save_every_nth == 0:
                ...
                torch.save(
                    ckpt.state_dict(),
                    os.path.join(ckpt_path, "final_ckpt.pt"),
                )
